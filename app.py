...
# Prompt template
prompt = """
You are an agent tasked with solving the user's mathematical question. Logically arrive at the solution and provide a detailed explanation.
Display the answer in bullet points.
...
if st.button("Find Answer"):
    if question:
        with st.spinner("Generating answer..."):
            ...
            response = assistant.run(question, callbacks=[st_cb])
